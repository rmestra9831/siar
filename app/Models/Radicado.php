...
{
    protected $fillable = ['consecutive','atention','origin_id','sede_id','program_id','first_name','last_name','origin_correo','origin_cel','type_reason','reason_id','affair','notes','slug','delegate_id','date_delegated','date_update_redirection','reasonAnswerCheck'];
